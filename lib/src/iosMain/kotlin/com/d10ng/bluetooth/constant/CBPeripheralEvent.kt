...
internal sealed class CBPeripheralEvent (
    ...
    class DidUpdateValueForCharacteristic(override val peripheral: CBPeripheral, val characteristic: CBCharacteristic, val data: ByteArray) : CBPeripheralEvent(peripheral)
    data class DidUpdateNotificationState(override val peripheral: CBPeripheral, val characteristic: CBCharacteristic, val result: Boolean) : CBPeripheralEvent(peripheral)
